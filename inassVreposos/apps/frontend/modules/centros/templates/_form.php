...
<?php endif; ?>
  <table>
    <tfoot>
      <tr>
        <td colspan="2">
          &nbsp;<a href="<?php echo url_for('centros/index') ?>">Regresar</a>
          <?php if (!$form->getObject()->isNew()): ?>
            &nbsp;<?php echo link_to('Borrar', 'centros/delete?id='.$form->getObject()->getId(), array('method' => 'delete', 'confirm' => 'Esta Ud Seguro?')) ?>
          <?php endif; ?>
